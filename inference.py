...
from evaluation_noisy import evaluate
...
if __name__ == "__main__":
    ...
    att_vis = configuration["inferencer"]['args']['att_vis']
    configuration['model']['backbone']['args']['att_vis'] = att_vis
    configuration['model']['head']['args']['att_vis'] = att_vis
