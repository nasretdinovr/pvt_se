...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, spec_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False, conv_cfg=None):
        super().__init__()
        ...
        for i in range(num_stages):
            patch_embed = OverlapPatchEmbed(spec_size=spec_size if i == 0 else spec_size // patch_size_t[i-1],
