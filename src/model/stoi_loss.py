...
def stoi_loss(y_pred_batch, y_true_batch,  reduction="mean"):
    ...
    for i in range(0, batch_size):  # Run over mini-batches
        y_true = y_true_batch[i, 0 : int(y_pred_batch.shape[1])]
        y_pred = y_pred_batch[i, 0 : int(y_pred_batch.shape[1])]
